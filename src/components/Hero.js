    ...
    <section id="hero" className="h-screen flex items-center bg-white -mb-8 md:-mb-12">
      <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center md:items-center justify-between">
        <div className="text-center md:text-left md:w-1/2 mb-12 md:mb-0 md:-mt-20">
          <SplitText
            className="text-4xl md:text-6xl font-bold text-pink-800 leading-tight mt-4 mb-4"
            delay={80}
            duration={0.8}
            splitType="words"
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-start gap-4 md:gap-4">
            <Link 
              to="/order" 
              className="inline-block bg-pink-500 border-2 border-transparent text-white font-bold text-lg px-12 py-4 rounded-lg shadow-lg hover:bg-pink-600 transform hover:-translate-y-1 transition-all duration-300"
            >
              Order Now
            </Link>
            <Link 
              to="/products"
              className="inline-block bg-transparent border-2 border-pink-500 text-pink-600 font-bold text-lg px-12 py-4 rounded-lg shadow-lg hover:bg-pink-50 hover:border-pink-600 hover:text-pink-700 transform hover:-translate-y-1 transition-all duration-300"
            >
              View Products
            </Link>
          </div>
