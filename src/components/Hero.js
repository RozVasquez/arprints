        ...
        <div className="text-center md:text-left md:w-1/2 mb-12 md:mb-0 md:-mt-20">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-start gap-4 md:gap-4">
            <a 
              ...
              className="w-full md:w-auto inline-block bg-red-500 border-2 border-transparent text-white font-bold text-lg px-12 py-4 rounded-lg shadow-lg hover:bg-red-600 transform hover:-translate-y-1 transition-all duration-300 text-center"
            >
              Order Now
            </a>
            <Link 
              to="/products"
              className="w-full md:w-auto inline-block bg-transparent border-2 border-red-500 text-red-600 font-bold text-lg px-12 py-4 rounded-lg shadow-lg hover:bg-red-50 hover:border-red-600 hover:text-red-700 transform hover:-translate-y-1 transition-all duration-300 text-center"
            >
              View Products
            </Link>
          </div>
