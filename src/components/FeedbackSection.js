...
function FeedbackSection() {
  ...
  // Filter feedbacks based on screen size
  const displayFeedbacks = isDesktop ? feedbacks : feedbacks.slice(0, 3);
  ...
  return (
    <section id="feedback" className="w-full py-12 md:py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        {/* Show "View More" message on mobile if there are more than 3 feedbacks */}
        {!isDesktop && feedbacks.length > 3 && (
          <div className="text-center mt-8">
            <p className="text-gray-500 text-sm">
              Showing 3 of {feedbacks.length} feedbacks. View on desktop to see all.
            </p>
          </div>
        )}
      </div>
